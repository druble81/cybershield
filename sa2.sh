...
if [[ $A -gt 0 ]]
then
/tmp/ramdisk/adf43515 3000 25000000 $C&
else
...
if [[ $A -gt 0 ]]
then
/tmp/ramdisk/adf43516 3000 25000000 $C&
else
...
if [[ $A -gt 0 ]]
then
/tmp/ramdisk/adf43517 3000 25000000 $C&
else
...
if [[ $A -gt 0 ]]
then
/tmp/ramdisk/adf43518 3000 25000000 $C&
else
...
if [[ $A -gt 0 ]]
then
/tmp/ramdisk/adf43519 3000 25000000 $C&
else
...
if [[ $A -gt 0 ]]
then
/tmp/ramdisk/adf4351 3000 25000000 $C&
else
...
if [[ $A -gt 0 ]]
then
/tmp/ramdisk/adf43512 3000 25000000 $C&
else
