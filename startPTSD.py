...
while True:
    ...
    # ---- RANDOM MICRO DWELL (bash-equivalent) ----
    sleep_str = f"0.000{random.randint(0,9)}{random.randint(0,9)}{random.randint(0,9)}"
    time.sleep(float(sleep_str))
