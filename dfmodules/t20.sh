...
hz1="0000"$(($RANDOM % 15 + 35)).$(($RANDOM % 10000))
hz2="0000"$(($RANDOM % 15 + 35)).$(($RANDOM % 10000))																																																																																																		
hz3="0000"$(($RANDOM % 15 + 35)).$(($RANDOM % 10000))
hz4="000"$(($RANDOM %  590 + 50)).$(($RANDOM % 10000))
hz5="0000"$(($RANDOM % 590 + 50)).$(($RANDOM % 10000))
hz9="000"$(($RANDOM % 590 + 50)).$(($RANDOM % 10000))
