...
hz4="0000"$(($RANDOM %  5 + 47)).$(($RANDOM % 10000))
hz5="0000"$(($RANDOM % 5 + 47)).$(($RANDOM % 10000))
hz9="0000"$(($RANDOM % 5 + 45)).$(($RANDOM % 10000))
...
hz12="0"$(($RANDOM % 500 + 15000)).$(($RANDOM % 10000))
hz22="0"$(($RANDOM % 640 + 20000)).$(($RANDOM % 10000))
hz32="0"$(($RANDOM % 500 + 40646)).$(($RANDOM % 10000))
hz42="0"$(($RANDOM % 300 + 10002)).$(($RANDOM % 10000))
hz52="0"$(($RANDOM %  500 + 10054)).$(($RANDOM % 10000))
hz92="0"$(($RANDOM %  500 + 10054)).$(($RANDOM % 10000))
