...
hz3="0000"$(($RANDOM % 5 + 47)).$(($RANDOM % 10000))
hz4="0000"$(($RANDOM %  540 + 100)).$(($RANDOM % 10000))
hz5="0000"$(($RANDOM % 540 + 100)).$(($RANDOM % 10000))
hz9="0000"$(($RANDOM % 540 + 100)).$(($RANDOM % 10000))


##wait period for itbs which allows for .2 and .8 gap..
hz6="000p"$(($RANDOM % 5 + 27))
hz7="0000"$(($RANDOM % 5 + 27))																																																																																																				
